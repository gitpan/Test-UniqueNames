...
use Data::Dumper;
use Test::Exception;
use Test::UniqueNames::Test;

my $CLASS = 'Test::UniqueNames::Tracker';
use_ok( $CLASS );
...
my $test = Test::UniqueNames::Test->new( 'phil', 692 );
...
my $test2 = Test::UniqueNames::Test->new( 'dick', 200 );
...
my $test3 = Test::UniqueNames::Test->new( undef, 9000 );
